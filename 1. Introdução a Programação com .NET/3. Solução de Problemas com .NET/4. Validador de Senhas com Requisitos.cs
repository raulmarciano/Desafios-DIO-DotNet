 ...
 *  tem uma string S, correspondente a senha que é inserida pelo usuário no momento do
 *  cadastro.
 *
 ************************************** Saída:
 *
 *  A saída contém uma linha, que pode ser “Senha valida.”, caso a senha tenha cada item
 *  dos requisitos solicitados anteriormente, ou “Senha invalida.”, se um ou mais
...
class MinhaClasse 
{
  ...
  public static bool ValidarSenha(string senha)
    => Regex.IsMatch(senha, (@"^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])[a-zA-Z0-9]{6,32}$"));
}