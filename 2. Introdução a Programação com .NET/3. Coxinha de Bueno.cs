 ...
 *  onde Mônica mandou pra dentro 43 coxinhas em apenas 10 minutos, passando se 
 *  antecessor que conseguiu comer, no mesmo tempo, 38 coxinhas em 2014.
 *
 ...
 *
 *  Porém, como jó foi informado, a especialidade deles é coxinha, não matemática, então
 *  será que você pode ajudá-los? Com base no número total de coxinhas consumidas e o
 *  número de participantes na competição, o dono do restaurante precisa que você
 ...
 *  (1 ≤ H, P ≤ 1000) indicando respectivamente o número total de coxinhas consumidas e
...
class Classe 
{
    static void Main() 
    {
        ...
        var coxinhas = Convert.ToDecimal(line[0]);
        var participantes = Convert.ToDecimal(line[1]);
        
        Console.WriteLine(Math.Round(coxinhas / participantes, 2).ToString("F"));
    }
}